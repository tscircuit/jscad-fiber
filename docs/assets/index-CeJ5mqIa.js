const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_virtual_cosmos-imports-Bj2MVcBl.js","./_virtual_cosmos-imports-BAmuu1zp.css"])))=>i.map(i=>d[i]);
...
async function mount() {
  const args = await __vitePreload(() => import("./_virtual_cosmos-imports-Bj2MVcBl.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
